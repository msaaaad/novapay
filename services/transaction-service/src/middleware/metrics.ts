...
client.collectDefaultMetrics({ prefix: 'transaction_service_' });
...
export const duplicateRequestCounter = new client.Counter({
  name: 'idempotency_duplicate_requests_total',
  help: 'Total duplicate requests caught by idempotency',
});
